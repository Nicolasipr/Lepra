...
long double productosSucesivos(long double b, long double e)
{
  if(e > 1)
    ...
    do
    {
        ...
        switch(tecla)
        {
            case 1:
                ...
                do{
                   ...
                   if (num1*num2 > 2147483647)
                        cout << "ERROR : Numero muy grande para tipo de variable";

                }while(num1*num2 >= 2147483647 ); // numero mas grande de los INT
                ...
                cout << "\nDivision entre " << num1  << " y  " << num2 << " es: " << restasSucesivas(num1,num2) << endl;


                cout << "\nSuma de digitos de 81726354 : " << sumaDigitos(81726354) << endl;

                cout << "\nExponenciación de 19 en 43 : " << productosSucesivos(19,2) << endl;
                cout << "\nFibonnacci 40 : " << fibonnacci(40) << endl;
                pausa();
                break;
            ...
            case 2:
                ...
                cout << "\t\t------------------------------\n";
                cout << "Producto Cola entre 9 y 23: " << sumasSucesivasCola(9,23) << endl;
                cout << "Division Cola entre 93 y 4: " << restasSucesivasCola(93,4) << endl;
                cout << "Suma de Digitos Cola de 81726354 : " << sumaDigitosCola(81726354) << endl;
                cout << "Exponenciación Cola de 19 en 43 : " << productoSucesivoCola(19,43) << endl;
                cout << "Fibonnacci Cola 40 : " << fibonacciCola(40) << endl;
